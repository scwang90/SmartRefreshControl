#
#  Be sure to run `pod spec lint SmartRefreshControl.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  spec.author             = { "scwang" => "scwang90@hotmail.com" }
  # Or just: spec.author    = "scwang"
  # spec.authors            = { "scwang" => "scwang90@hotmail.com" }
  # spec.social_media_url   = "https://twitter.com/scwang"
  ...
  spec.source_files  = "SmartRefreshControl", "SmartRefreshControl/**/*.{h,m}"
  # spec.exclude_files = "SmartRefreshControl/Vector/Refresh-Bridging-Header.h"

  spec.public_header_files = "SmartRefreshControl/*.h", "SmartRefreshControl/**/*.h"
